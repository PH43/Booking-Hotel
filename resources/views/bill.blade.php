...
">
    ...
    height: 100%;
">
                                                <img src="../resources/images/rooms/{{ $rooms->first()->images->first()->path}}" class="jss41 jss136" alt="" style="top: 0;left: 0;width: 100%;height: 100%;border-radius: 8px;position: absolute;object-fit: cover;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
