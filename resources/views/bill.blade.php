...
">Chúng tôi sẽ chủ động liên hệ với quý khách trong vòng 30 phút để xác nhận phòng trống và hướng dẫn thanh toán.</div>
                            ...
                            <div class="MuiBox-root jss54 jss4" style="
    padding: 16px 24px 0 24px;
">
                                <div class="MuiBox-root jss82 jss55" style="
    margin: 16px 0;
">
                                    <div class="MuiBox-root jss83 jss59">
                                        <div class="MuiBox-root jss84">
                                            <div class="MuiBox-root jss85">
                                                <h6 class="MuiTypography-root jss57 MuiTypography-subtitle1" style="
    display: flex;
    font-size: 16px;
    ...
    line-height: 20px;
    flex-direction: column;
">InterContinental Da Nang Sun Peninsula Resort</h6>
                                                <div class="MuiBox-root jss86" style="
    display: flex;
    margin-top: 8px;
    align-items: center;
">
                                                    ...
                                                    <div class="MuiBox-root jss99 jss90" style="
    color: #FF3366;
...
">Khu nghỉ dưỡng</span>
                                    ...
                                    <div class="MuiBox-root jss100 jss66" style="
    display: flex;
    align-items: center;
...
">
                                        <div class="MuiBox-root jss101" xs="5">
                                            <p class="MuiTypography-root jss67 MuiTypography-body1" style="
    color: #4A5568;
    font-size: 14px;
    margin-top: 12px;
    font-weight: 600;
    ...
    margin-bottom: 0px;
">Nhận phòng</p>
                                            <p class="MuiTypography-root jss70 MuiTypography-body1" style="
    color: #1a202c;
    font-size: 14px;
    font-weight: 400;
    margin-bottom: 0;
">Thứ 5
                                                <span class="MuiBox-root jss102">, 04 Tháng 11</span>
                                            </p>
                                        ...
                                        <div class="MuiBox-root jss103 jss69" xs="5" style="
    text-align: left;
    margin-left: 40px;
">
                                            <p class="MuiTypography-root jss67 MuiTypography-body1" style="
...
">Trả phòng</p>
    ...
    line-height: 17px;
">Thứ 6
                                                <span class="MuiBox-root jss104">, 05 Tháng 11</span>
                                            </p>
                            ...
                            <div class="MuiBox-root jss105 jss4" style="padding-top: 0px;padding: 0px 24px 0 24px;">
                                <div class="MuiBox-root jss153 jss106" style="
    display: flex;
    border-bottom: 1px solid #EDF2F7;
    justify-content: space-between;
">
                                    <div class="MuiBox-root jss154 jss107" style="
    /* display: flex; */
    /* align-items: center; */
    /* width: 70%; */
    border-bottom: 1px solid #EDF2F7;
">
                                        <div class="MuiBox-root jss155 jss123" style="
    color: #1a202c;
    display: flex;
    align-items: center;
">
                                            <span class="MuiTypography-root MuiTypography-subtitle1" style="margin-right: 3px;font-size: 16px;font-family: -apple-system,BlinkMacSystemFont,sans-serif;font-weight: 600;line-height: 20px;">1x</span>
    ...
    line-height: 20px;
    margin-bottom: 0;
">Resort Classic Room (King/Twin)</h6>
                                        </div>
...
">Bữa sáng miễn phí</p>
                                        ...
                                        <div class="MuiBox-root jss161" style="display: flex;align-items: center;color: #1a202c;margin-top: 8px;">
                                            ...
                                            <p class="MuiTypography-root jss109 MuiTypography-body1" style="
    margin-bottom: 0;
    color: #4A5568;
    font-size: 14px;
    font-weight: normal;
...
">
    ...
    height: 100%;
">
                                                <img src="https://tripi.vn/cdn-cgi/image/width=320/https://www.googleapis.com/download/storage/v1/b/tourcdn/o/photos%2FA378DW04EC_%2Ftmp%2Fplaytemp1520709976633082362%2FmultipartBody6070611450924745719asTemporaryFile?generation=1587666345968344&amp;alt=media" class="jss41 jss136" alt="" style="
    top: 0;
    left: 0;
    width: 100%;
    height: 100%;
                                        ...
                                        <div class="MuiGrid-root MuiGrid-container">
                                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-sm-10 MuiGrid-grid-md-10 MuiGrid-grid-lg-10">
                                                <div class="MuiButtonBase-root MuiAccordionSummary-root jss166" tabindex="0" role="button" aria-disabled="false" aria-expanded="false" aria-controls="panel1a-content" id="panel1a-header">
                                                    ...
                                                    <div class="MuiButtonBase-root MuiIconButton-root MuiAccordionSummary-expandIcon jss168 MuiIconButton-edgeEnd" aria-disabled="false" aria-hidden="true">
                                                        <span class="MuiIconButton-label">
                                                            <svg width="10" height="6" fill="none" class="svgFillAll jss137"><path d="M1 1l4 4 4-4" stroke="#4A5568" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                                                        </span>
                                            ...
                                            <div class="MuiGrid-root jss149 MuiGrid-item MuiGrid-grid-sm-2 MuiGrid-grid-md-2 MuiGrid-grid-lg-2">
                                                <h6 class="MuiTypography-root MuiTypography-subtitle1">7.618.000đ</h6>
                                            </div>
                                        </div>
                                                    ...
                                                    <div role="region">
                                                        <div class="MuiAccordionDetails-root" style="padding: 0px;">
                                                            <div class="MuiBox-root jss171 jss138">
                                                                <div class="MuiBox-root jss172 jss139">
                                                                    <span class="MuiBox-root jss173">1 phòng x 1 đêm</span>
                                                                    <span class="MuiBox-root jss174 jss148">
                                                                        <span class="MuiBox-root jss175">7.549.022đ</span>
                                                                    </span>
                                                                </div>
                                                                <div class="MuiBox-root jss176 jss139">
                                                                    <span class="MuiBox-root jss177">Chúng tôi khớp giá, giảm thêm</span>
                                                                    -1.101.952đ
                                                                </div>
                                                                <div class="MuiBox-root jss178 jss139">
                                                                    <span class="MuiBox-root jss179">Thuế và phí dịch vụ khách sạn</span>
                                                                    1.170.
                                                                </div>
                                                                <div class="MuiBox-root jss180 jss139">
                                                                    <span class="MuiBox-root jss181 jss146">Mã giảm giá </span>
                                                                    <div class="MuiBox-root jss182">
                                                                        <span class="MuiTypography-root jss145 MuiTypography-body1" style="color: rgb(72, 187, 120);">0đ</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
